...
import {ArrowLeft, Calendar, Heart, Info, MapPin, Star} from 'lucide-react';
import {Splide, SplideSlide} from '@splidejs/react-splide';
import '@splidejs/react-splide/css';

const LoadingState = () => (<div className="flex items-center justify-center h-64 space-x-2">
...
const ImageGallery = ({photos}) => (<div className="flex-1">
        <Splide
            options={{
                type: 'loop', perPage: 1, gap: '1rem', arrows: true, pagination: true,
            }}
            ...
            <div className="space-y-8">
                ...
                <div className="flex justify-between items-start">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        />
                        <button
                            className={`p-2 rounded-full hover:bg-gray-100 transition-colors ${lodging.isFavorite ? 'text-red-500' : 'text-gray-400'}`}
                        >
